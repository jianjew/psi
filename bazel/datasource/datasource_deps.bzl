...
def _org_apache_arrow():
    maybe(
        ...
        build_file = "//bazel/datasource:arrow.BUILD",
    )
...
def _org_pocoproject_poco():
    maybe(
        ...
        build_file = "//bazel/datasource:poco.BUILD",
    )
...
def _com_mysql():
    maybe(
        ...
        build_file = "//bazel/datasource:mysql.BUILD",
    )
...
def _org_postgres():
    maybe(
        ...
        build_file = "//bazel/datasource:postgres.BUILD",
    )
...
def _org_unixodbc():
    maybe(
        ...
        build_file = "//bazel/datasource:unixodbc.BUILD",
    )
...
def _org_sqlite():
    maybe(
        ...
        build_file = "//bazel/datasource:sqlite3.BUILD",
    )
...
def _com_github_duckdb():
    maybe(
        ...
        build_file = "//bazel/datasource:duckdb.BUILD",
    )
...
def _ncurses():
    maybe(
        ...
        build_file = "//bazel/datasource:ncurses.BUILD",
    )
